...
<div class="nk-main ">
<!-- sidebar @s -->
<div class="nk-sidebar nk-sidebar-fixed" data-content="sidebarMenu" style="background:#138D75;">
<div class="nk-sidebar-element nk-sidebar-head" style="border:none;">
<div class="nk-sidebar-brand" style="border-bottom:none;">
<a href="html/index.html" class="logo-link nk-sidebar-logo"  style="border-bottom:none;margin-bottom:10px;">
<!-- <img class="logo-light logo-img" src="../src/assets/logo.png"  alt="logo">
<img class="logo-dark logo-img" src="" alt="logo-dark"> -->
<div style="font-size:20px;font-weight:bolder;color:white;padding-top:15px;">
<span style="border-bottom:solid thin white;padding-bottom:7px;">Uganda Carbon Registry</span>
...
<p>Know your carbon footprint <span> More</span></p>
...
<router-link to="/" class="router_menu">
 Home
</router-link>
</li>
...
<!-- main header @e -->
<!-- content @s -->
<div class="nk-content" style="background:white;">
<div class="container-fluid" style="background:white;">
<div class="nk-content-inner" style="background:white;">
...
@import url('../src/assets/template1/css/style-email.css');
