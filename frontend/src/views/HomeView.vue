...
<section  style="background:#784212;padding:20px;">
<div class="container">
<div class="text-center mx-auto p-10">
<h2 class=""><span style="font-size:35px;letter-spacing:1px;font-weight:bolder;color:white; font-family: system-ui;">
  Greenhouse Gas Emissions</span> </h2>
<div style="font-size:16px;padding:10px;">
<span style="color:white;padding:10px;padding-left:20px;padding-right:20px;border-right:solid 1px white;"> <i class="bi bi-calculator"></i> Calculate your carbon footprint</span>
<span style="color:white;padding-left:15px;">
  <i class="bi bi-tree-fill"></i>  Take part in carbon offsetting
</span>
</div>
</div>
</div>
  ...
  <section>
    <div class="row">
      <div class="col-md-12 col-12" style="background:black;height:5px;"></div>
      <div class="col-md-12 col-12" style="background:yellow;height:5px;"></div>
      <div class="col-md-12 col-12" style="background:red;height:5px;"></div>
...
<h2 class="p-10" st><span style="font-size:35px;letter-spacing:1px;font-weight:"> Greenhouse Gas Emissions</span> </h2>
<div style="font-size:16px;padding:5px;">
<span style="color:white;padding:10px;border-radius:50px;padding-left:20px;padding-right:20px;background:#138D75;"> Help reduce reduce carbon your footprint!</span>
</div>
</div>
</div>
</section> -->
  ...
  <section  style="background:white;padding-top:30px;padding-bottom:0px;margin-top:0px;">
  <div class="container">
  <div class="row">

  <!-- <div class="col-lg-12 col-12 text-center mx-auto" style="background:#138D75;">
  <h2 class="mb-5"><span style="padding-bottom:10px;font-size:35px;letter-spacing:1px;color:#138D75;font-weight:bolder;"> Greenhouse Gas Emissions</span> </h2>
  </div> -->




  <!-----Pollution by section------->

  <div class="col-lg-3 col-md-6 col-12 mb-4 mb-lg-0 pollution_option">
  <div class="featured-block d-flex justify-content-center align-items-center">
  <a href="donate.html" class="d-block pollution_option">
  <img src="../assets/icons/sector1.png" class="featured-block-image img-fluid pollution_icon" alt="" >
...
<span style="color:black" class="emission_amount">{{ item1.amount }}</span>
  ...
  <div class="col-lg-3 col-md-6 col-12 mb-4 mb-lg-0 pollution_option">
    <div class="featured-block d-flex justify-content-center align-items-center">
    <a href="donate.html" class="d-block pollution_option">
    <img src="../assets/icons/sector2.png" class="featured-block-image img-fluid pollution_icon" alt="" >
    <p class="featured-block-text">
    <strong>{{ item2.name }}
    </strong></p>
    <div class='emission_description'>
    ...
    <div class="col-lg-3 col-md-6 col-12 mb-4 mb-lg-0 pollution_option">
      <div class="featured-block d-flex justify-content-center align-items-center">
      <a href="donate.html" class="d-block pollution_option">
      <img src="../assets/icons/sector3.png" class="featured-block-image img-fluid pollution_icon" alt="" >
      <p class="featured-block-text">
      <strong>{{ item3.name }}
      </strong></p>
      <div class='emission_description'>
      ...
      <div class="col-lg-3 col-md-6 col-12 mb-4 mb-lg-0 pollution_option">
        <div class="featured-block d-flex justify-content-center align-items-center">
        <a href="donate.html" class="d-block pollution_option">
        <img src="../assets/icons/sector4.jpeg" class="featured-block-image img-fluid pollution_icon" alt="" >
        <p class="featured-block-text">
        <strong>{{ item4.name }}
        </strong></p>
        <div class='emission_description'>
  ...
  <img src="../assets/images/deforestation.jpeg" class="custom-text-box-image img-fluid" alt="">
  </div>
  ...
  <section class="cta-section section-padding section-bg" style="background:white;">
  <div class="container">
  ...
  <img src="../assets/images/deforestation.jpeg" class="custom-block-image img-fluid" alt="">
  ...
  <div class="col-lg-6 col-12">
  <img src="../assets/images/deforestation.jpeg"
  ...
  data(){return{
  //emission by key sectors

item1:{name:'Industries',amount:'200M T',icon:'../assets/icons/co2.png'},
item2:{name:'Transport',amount:'200M T',icon:'/assets/icons/water-drop.png'},
item3:{name:'Energy Use',amount:'200M T',icon:'/assets/icons/land_pollution.jpeg'},
item4:{name:'Wastes',amount:'200M T',icon:'/assets/icons/weather.png'}
